...
class TestSignedFeeDustAuthorization(unittest.TestCase):
    ...
    def test_effective_fee_must_not_exceed_fee_covered_by_signature(self):
        # Leave 500 nRTC of change. coin_select() absorbs change below the
        # 1,000-nRTC dust threshold into the effective fee.
        ...
        # applied. Current code returns HTTP 200 and records the absorbed dust.
        ...
        self.assertIsNone(row, "unsigned effective fee reached the ledger")
